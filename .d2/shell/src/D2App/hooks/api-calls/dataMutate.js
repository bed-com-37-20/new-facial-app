  ...
  const eventMutation = {
    ...
    data: _ref2 => {
      ...
      return {
        ...
        status: 'ACTIVE',
        dataValues: [{
          dataElement: 'qBdgukop1PZ',
          value: attendance
        }, {
          dataElement: 'mhqnDet3fWt',
          value: startTime
        }, {
          dataElement: 'zntfl5UMciM',
          value: endTime
        }, {
          dataElement: 'UpWL174vwH2',
          value: courseName
        }, {
          dataElement: 'ElIwWBmR9f6',
          value: examRoom
        }, {
          dataElement: 'hNJqe05ItzH',
          value: supervisor
        }, {
          dataElement: 'c7BLipnXpPM',
          value: date
        }]
      };
    }
